...
export default function Login({ isDark, setIsDark }) {
  ...
  return (
    <div className="min-h-screen bg-canvas flex flex-col md:flex-row items-center justify-center p-4 md:p-12 overflow-hidden relative">
      ...
      <div className="w-full md:w-1/2 flex flex-col items-center md:items-start justify-center p-8 md:p-16 z-10 text-center md:text-left">
        <div className="w-20 h-20 bg-panel-hover rounded-2xl flex items-center justify-center mb-8 shadow-lg border border-line">
          <Scale size={48} className="text-blue-400" />
        </div>
        <h1 className="text-5xl md:text-7xl font-bold text-ink mb-6 tracking-tight">
          LegalView
        </h1>
        <p className="text-xl md:text-3xl font-light text-muted leading-relaxed max-w-xl">
      ...
      <div className="w-full md:w-1/2 flex items-center justify-center z-10 mt-8 md:mt-0">
        <div className="w-full max-w-md bg-panel/60 backdrop-blur-xl border border-line rounded-3xl p-8 md:p-10 shadow-2xl flex flex-col items-center">
          
          <h2 className="text-2xl font-semibold text-ink mb-2 text-center">Welcome Back</h2>
          <p className="text-muted text-sm text-center mb-8 px-2">
          ...
          <div className="w-full space-y-4">
            ...
            <button
              ...
              disabled={loading}
              className="cursor-pointer w-full flex items-center justify-center gap-3 bg-panel-hover/80 text-ink border border-line py-3.5 rounded-xl font-medium hover:bg-panel-hover transition-all disabled:opacity-50 shadow-sm backdrop-blur-md"
            >
              <User size={18} />
              Continue as Guest
            </button>
